...
In Claude.ai, open Settings → Skills
Upload the premium-app-ui folder or the .skill file if packaged
The skill will trigger automatically whenever Claude builds any UI
